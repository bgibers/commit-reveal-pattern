...
🔏 Edit your smart contract `CommitReveal.sol` in `packages/hardhat/contracts`
...
📚 Go through each topic from [solidity by example](https://solidity-by-example.org) editing `CommitReveal.sol` in **🏗 scaffold-eth**
